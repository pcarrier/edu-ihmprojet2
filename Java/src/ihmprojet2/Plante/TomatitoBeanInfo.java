 ...
 * @author jc
 */
public class TomatitoBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_germee = 0;
    private static final int PROPERTY_taille = 1;
    private static final int PROPERTY_vivante = 2;
    ...
    private static final int METHOD_isGermee0 = 0;
    private static final int METHOD_isVivante1 = 1;
